...
public:
    ...
    bool m_is_accelerating_down = false;
    ...
    void const set_game_won(bool new_state)                 { m_game_won = new_state;};
    void const set_game_loss(bool new_state)                 { m_game_loss = new_state;};
