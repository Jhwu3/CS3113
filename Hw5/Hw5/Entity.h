...
enum AIState    { WALKING, IDLE, ATTACKING, Jumping, Patrol, RunPatrol };
...
public:
    ...
    bool m_about_to_fall_right = false;
    bool m_about_to_fall_left = false;
    bool m_patrol_idle = true; 

    GLuint    m_texture_id;
    int m_number_lives = 3;
    ...
    void const check_about_to_fall(Map* map);
